...
<style scoped>
.page { height: 100vh; display: flex; flex-direction: column; background: #f4f6f9; }
.header-bar { display: flex; justify-content: space-between; align-items: center; padding: 12px 16px 10px; background: #fff; color: #172033; flex-shrink: 0; }
.merchant-info { display: flex; flex-direction: column; gap: 2px; }
.merchant-name { font-size: 18px; font-weight: 800; line-height: 24px; }
.merchant-subtitle { font-size: 12px; color: #7b8494; }
.header-actions { display: flex; gap: 16px; }
.scan-btn { font-size: 20px; }
.banner-swiper { height: 154px; margin: 0 12px 10px; border-radius: 12px; overflow: hidden; background: #dfe5ee; box-shadow: 0 6px 18px rgba(20,31,51,0.08); flex-shrink: 0; position: relative; }
...
.qualification-card { height: 154px; margin: 0 12px 10px; border-radius: 12px; box-sizing: border-box; padding: 18px; background: linear-gradient(135deg, #1f6bd8, #22a06b); color: #fff; display: flex; align-items: center; justify-content: space-between; flex-shrink: 0; overflow: hidden; }
...
.search-input { background: #fff; border-radius: 22px; padding: 10px 16px; font-size: 14px; box-shadow: 0 1px 4px rgba(20,31,51,0.04); }
.category-scroll { white-space: nowrap; padding: 0 12px 10px; background: transparent; flex-shrink: 0; box-sizing: border-box; }
.category-tag { display: inline-flex; align-items: center; gap: 6px; padding: 8px 12px; margin-right: 8px; border-radius: 16px; background: #fff; font-size: 13px; color: #4c5667; transition: all 0.2s; box-shadow: 0 1px 4px rgba(20,31,51,0.04); }
.category-tag.active { background: #1a73e8; color: #fff; font-weight: 700; box-shadow: 0 5px 14px rgba(26,115,232,0.24); }
